...
+ (UIImage*)brightness:(double)amount image:(UIImage*)img {
    return [ImageFilter filter:@"CIColorControls" params:
            [NSDictionary dictionaryWithObjectsAndKeys:
             [NSNumber numberWithFloat:amount], @"inputBrightness",
             nil] image:img
            ];
...
+ (UIImage *)filter:(NSString *)filterName params:(NSDictionary *)theParams image:(UIImage*)img {
