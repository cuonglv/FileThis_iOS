...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
	{
        ...
        [self.contentView.layer setBorderColor:kLightGrayColor.CGColor];
...
{
    if ([self.pageDelegate respondsToSelector:@selector(didPageDoubleTap:)]) {
        [self.pageDelegate didPageDoubleTap:self];
    }
}
...
- (void)layoutSubviews
{
	UIView *currentContentView = self.contentView;
